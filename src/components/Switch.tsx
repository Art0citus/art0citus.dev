...
const StyledWrapper = styled.div`
  ...
  .toggle-handle-bar {
    ...
    transition: background-position-x 0.24s
      cubic-bezier(0.65, 1.35, 0.5, 1);
    box-shadow: inset 0 0.5em 0.15em rgb(0 0 0 / 0.4);
  }
  ...
  .toggle-base {
    ...
    box-shadow: 0 -0.15em 0.3em #fff,
      0 0.15em 0.3em #d7d7d7;
  }
  ...
  .toggle-base-inside {
    ...
    box-shadow: inset 0 0.0625em rgb(255 255 255 / 0.2),
      ...
      inset 0 -0.0625em 0.15em rgb(0 0 0 / 0.1);
  }
