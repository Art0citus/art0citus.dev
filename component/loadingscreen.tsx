...
import { Bold, Volume2, VolumeX } from "lucide-react";
...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    audioRef.current = new Audio("/spidy.mp3");
    ...
    }, 21); // Matches your Spider-Man GIF (~2.1 seconds)
  ...
  return (
    <div className="flex min-h-screen w-full justify-center bg-white px-4 sm:px-6 lg:px-8">
      <div
        className={`relative flex min-h-screen w-full max-w-4xl items-center justify-center overflow-hidden bg-background transition-opacity duration-500 ${isFading ? "opacity-0" : "opacity-100"
          }`}
      ><button
        onClick={toggleSound}
      ...
      >
        ...
        <Image
          ...
          width={1600}
          height={100}
          className="absolute -bottom-102 left-0 w-[180%] max-w-none h-auto z-0  animate-skyline"
        />
